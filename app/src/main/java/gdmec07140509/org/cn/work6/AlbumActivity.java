package gdmec07140509.org.cn.work6;
...
public class AlbumActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadAlbum();
        if (mBgList == null){
            Toast.makeText(this,"相册图片",Toast.LENGTH_SHORT).show();
            finish();
            return;
        }else {
    ...
    public  Bitmap loadImage(String pathName){
        ...
        WindowManager mange = getWindowManager();
        Display display = mange.getDefaultDisplay();
